...
describe('A figure calculator', () => {
  ...
  describe('A calculateRectangleArea function', () => {
    ...
    it('should return correct value based on rectangle parameter formula', () => {
      // Arrange
      const length = 20
      const width = 10
      const spyMultiply = jest.spyOn(MathBasic, 'multiply')
  ...
  describe('A calculateTrianglePerimeter function', () => {
    it('should throw error when not given 3 parameters', () => {
      ...
      expect(() => figureCalculator.calculateTrianglePerimeter(1, 3, 5, 1)).toThrowError()
    })
    ...
    it('should throw error when given with non-number parameters', () => {
      ...
      expect(() => figureCalculator.calculateTrianglePerimeter(null, '2', 'fff')).toThrowError()
      expect(() => figureCalculator.calculateTrianglePerimeter([], {}, '')).toThrowError()
    })
